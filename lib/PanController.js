...
class PanController extends Component {
  ...
  constructor(props) {
    ...
    this.handleMomentumScroll = this.handleMomentumScroll.bind(this);
    this.handleSnappedScroll = this.handleSnappedScroll.bind(this);
    this.momentumCenter = this.momentumCenter.bind(this);
    this.velocityAtBounds = this.velocityAtBounds.bind(this);
...
PanController.propTypes = propTypes;
PanController.defaultProps = defaultProps;
